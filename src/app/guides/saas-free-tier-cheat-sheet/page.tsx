            ...
            <div className="overflow-x-auto rounded-lg border border-border mt-4">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-border">
                  ...
                  <tr><td className="px-3 py-2 font-medium text-foreground">ClickUp</td><td className="px-3 py-2">Unlimited tasks + members, 60MB</td><td className="px-3 py-2">Storage, integrations, dashboards</td><td className="px-3 py-2 text-green-600 font-medium">Excellent</td></tr>
